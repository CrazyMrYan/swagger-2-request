 ...
 * @tags pet
 */
export async function petPetIdUploadImagePost(petId: any, options?: Types.RequestOptions): Promise<Types.PetPetIdUploadImagePostResponse> {
 ...
 * @tags pet
 */
export async function petPetIdGet(petId: any, options?: Types.RequestOptions): Promise<Types.PetPetIdGetResponse> {
  const url = `/pet/${petId}`;
 ...
 * @tags pet
 */
export async function petPetIdPost(petId: any, options?: Types.RequestOptions): Promise<any> {
  const url = `/pet/${petId}`;
 ...
 * @tags pet
 */
export async function petPetIdDelete(petId: any, options?: Types.RequestOptions): Promise<any> {
  const url = `/pet/${petId}`;
 ...
 * @tags store
 */
export async function storeOrderOrderIdGet(orderId: any, options?: Types.RequestOptions): Promise<Types.StoreOrderOrderIdGetResponse> {
 ...
 * @tags store
 */
export async function storeOrderOrderIdDelete(orderId: any, options?: Types.RequestOptions): Promise<any> {
  const url = `/store/order/${orderId}`;
 ...
 * @tags user
 */
export async function userUsernameGet(username: any, options?: Types.RequestOptions): Promise<Types.UserUsernameGetResponse> {
 ...
 * @tags user
 */
export async function userUsernamePut(username: any, options?: Types.RequestOptions): Promise<any> {
  const url = `/user/${username}`;
 ...
 * @tags user
 */
export async function userUsernameDelete(username: any, options?: Types.RequestOptions): Promise<any> {
  const url = `/user/${username}`;
